...
This runs your TypeScript file with native TypeScript support—no compilation step required. The CLI automatically resolves `thinkwell:*` imports and processes `@JSONSchema` annotations.
